...
1. Run the below command to start the game:
    ...
    <img src="./hangman_player_won.jpg" width="50%" height="50%" style="border: 1px solid black">
    <img src="./hangman_player_lost.jpg" width="50%" height="50%" style="border: 1px solid black">
