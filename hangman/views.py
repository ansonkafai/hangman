...
def validate_player_guess(hangman_game_data: HangmanGameData) -> Tuple[bool, str]:
    """Validate guess letter entered by player.

    Args:
        hangman_game_data: HangmanGameData data object for getting the guess letter and already_guessed_letters list.
...
def get_player_guess(hangman_game_data: HangmanGameData) -> str:
    ...
    while True:
        ...
        if input_err:
            ...
            show_hangman_board(hangman_game_data)
...
def show_hangman_board_title() -> None:
    """Show Hangman board title to console."""
    click.secho(" H A N G M A N ", fg="white", bg="green", bold=True)


def get_hangman_pic(hangman_game_data: HangmanGameData) -> str:
...
def show_hangman_pic(hangman_game_data: HangmanGameData) -> None:
    """Show Hangman picture to console according to the number of missed guesses.

    Args:
        hangman_game_data: The data object for retrieving the number of missed letters.
    """
    click.secho(get_hangman_pic(hangman_game_data), fg="bright_red", bold=True)


def show_missed_letters(hangman_game_data: HangmanGameData) -> None:
...
def show_secret_word_with_correct_letters(hangman_game_data: HangmanGameData) -> None:
...
def show_hangman_board(hangman_game_data: HangmanGameData) -> None:
    ...
    """
    clear_screen()
    show_hangman_board_title()
    show_hangman_pic(hangman_game_data)
    show_missed_letters(hangman_game_data)
    show_secret_word_with_correct_letters(hangman_game_data)


def get_player_won_message(hangman_game_data: HangmanGameData) -> str:
...
def show_player_won(hangman_game_data: HangmanGameData) -> None:
    """Show player won message.

    Args:
        hangman_game_data: The data object for retrieving the secret word.
    """
    click.secho(get_player_won_message(hangman_game_data), fg="blue")


def get_player_lost_message_first_line(hangman_game_data: HangmanGameData) -> str:
...
def get_player_lost_message_second_line(hangman_game_data: HangmanGameData) -> str:
...
def show_player_lost(hangman_game_data: HangmanGameData) -> None:
    """Show player lost message to console.

    Args:
        hangman_game_data: The data object for retrieving the numbers of missed letters and correct letters.
    """
    click.secho(get_player_lost_message_first_line(hangman_game_data), fg="bright_red")
    click.secho(get_player_lost_message_second_line(hangman_game_data))
